...
(9, 'Painting', 'Artworks created using paint on a surface'),
(10, 'Digital Art', 'Artworks made using digital tools'),
(11, 'Sculpture', 'Three-dimensional art made by shaping materials'),
(12, 'Photography', 'Artworks captured using a camera'),
(13, 'Printmaking', 'Artworks created by printing techniques like etching or lithography'),
(14, 'Drawing', 'Artworks created using pencils, charcoal, or ink on paper'),
(15, 'Textile Art', 'Artworks made using fabric, thread, or weaving techniques'),
(16, 'Ceramics', 'Artworks made from clay and hardened by heat'),
(17, 'Abstract Art', 'Artworks that use shapes, colors, and forms to create compositions that don`t represent reality'),
(18, 'Conceptual Art', 'Art where the idea behind the artwork is more important than the physical object itself'),
(19, 'Installation Art', 'Three-dimensional works that are often site-specific and designed to transform a space'),
(20, 'Performance Art', 'Artworks involving live performance, often including visual elements, sound, and movement'),
(21, 'Street Art', 'Visual art created in public locations, typically unsanctioned and often political or social in nature'),
(22, 'Video Art', 'Art that uses video technology as its medium, often creating immersive or experimental experiences'),
(23, 'Glass Art', 'Artworks made with glass, including sculptures, windows, and other decorative pieces'),
(24, 'Mixed Media', 'Artworks that combine different materials and methods to create a single work of art');
