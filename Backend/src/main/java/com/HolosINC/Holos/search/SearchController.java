...
public class SearchController {
    ...
    @Operation(summary = "Search for works", description = "Performs a search for artworks based on text query and optional price range.")
    ...
    @Operation(summary = "Search for artists", description = "Search artists by text query and/or minimum number of works done.")
    ...
    @GetMapping("/artists")
    public ResponseEntity<Page<SearchArtistDTO>> searchArtists(
        ...
        Page<SearchArtistDTO> results = searchService.searchArtists(query, minWorksDone, page, size);
        return ResponseEntity.ok(results);
    }

    @Operation(summary = "Get works by artist", description = "Returns a paginated list of works made by a specific artist.")
    ...
    @Operation(summary = "Global search for works and artists", description = "Performs a combined search on works and artists with multiple filters.")
