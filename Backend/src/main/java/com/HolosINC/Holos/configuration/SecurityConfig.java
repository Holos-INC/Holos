...
public class SecurityConfig {
    ...
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.PUT, "/api/v1/commisions/next/accept/**").hasAuthority("CLIENT")
            .requestMatchers(HttpMethod.PUT, "/api/v1/commisions/next/deny/**").hasAuthority("CLIENT")
            .requestMatchers(HttpMethod.PUT, "/api/v1/commisions/*/upload-image").hasAnyAuthority("ARTIST", "ARTIST_PREMIUM")
